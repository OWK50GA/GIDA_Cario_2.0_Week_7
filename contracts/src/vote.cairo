...
pub mod VotingContract {
    ...
    use contracts::vote_component::{ThumbsUpComponent};

    component!(path: ThumbsUpComponent, storage: thumbs_up, event: ThumbsUpEvent);
    ...
    pub struct Storage {
        ...
        #[substorage(v0)]
        thumbs_up: ThumbsUpComponent::Storage,
    }
    ...
    pub enum Event {
        ThumbsUpEvent: ThumbsUpComponent::Event,
    }
    ...
    #[abi(embed_v0)]
    impl ThumbsUpImpl = ThumbsUpComponent::ThumbsUpper<ContractState>;
